<template>
  <div class="wrapper">
    ...
    <div v-for="airport in airports" :key="airport.abbreviation">
      <airport-card :airport="airport" @click="addAirportToFavorites(airport)" />
    </div>
...
export default{
  ...
  methods: {
    addAirportToFavorites(favoriteAirport){
      this.$store.dispatch('airports/addToFavorites', favoriteAirport)
    }
  }
}
